...
class ExtractedPage:
    ...
    # field(default_factory=dict) permet d'initialiser metadata à un dictionnaire vide par défaut, évitant les problèmes liés aux objets mutables partagés entre instances
